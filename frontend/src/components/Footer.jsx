                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-14">
                    ...
                    <div className="md:col-span-3">
                        ...
                        <div className="flex gap-3 mb-6">
                            {/* Instagram */}
                            <a href="https://www.instagram.com/careerverse.lk?igsh=OHV3emN3Y3ZrM2Mz" target="_blank" rel="noopener noreferrer" className="footer-social-icon" aria-label="Instagram">
                            ...
                            {/* LinkedIn */}
                            <a href="https://www.linkedin.com/company/careerverse.lk/" target="_blank" rel="noopener noreferrer" className="footer-social-icon" aria-label="LinkedIn">
                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
